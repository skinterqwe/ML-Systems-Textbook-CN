...
| **时代** | **计算模式** | **架构示例** | **特征** |
|---:|:---|:---|:---|
| **1980s** | 浮点与信号处理 | FPU, DSP | <ul><li>单用途引擎</li><br><li>聚焦指令集</li><br><li>协处理器接口</li></ul> |
| **1990s** | 3D 图形与多媒体 | GPU, SIMD 单元 | <ul><li>大量相同的计算单元</li><br><li>规则的数据模式</li><br><li>宽内存接口</li></ul> |
| **2000s** | 实时媒体编码 | 媒体编解码器, 网络处理器 | <ul><li>固定功能管线</li><br><li>高吞吐量处理</li><br><li>功耗-性能优化</li></ul> |
| **2010s** | 深度学习张量运算 | TPU, GPU 张量核心 | <ul><li>矩阵乘法单元</li><br><li>大规模并行</li><br><li>内存带宽优化</li></ul> |
| **2020s** | 应用特定加速 | 机器学习引擎, 智能网卡, 领域加速器 | <ul><li>工作负载特定的数据路径</li><br><li>定制内存层次结构</li><br><li>应用优化的设计</li></ul> |
...
|:---|:---|:---|:---|
|  |  | <li> 层转换</li> |  |
| **矩阵运算** | 多对多转换 | <li> 注意力计算</li><br><li> 卷积</li><br><li> 激活函数</li> | 每个输出取决于多个输入 |
| **向量运算** | 一对一转换 | <li> 层归一化</li><br><li> 逐元素梯度</li> | 每个输出仅取决于相应的输入 |
